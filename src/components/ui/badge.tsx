...
export default function Badge({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between border border-black-400 font-geist text-white-200 group transition-colors duration-300 gap-1 px-2.5 py-3 rounded-3xl h-6 text-sm",
        className
      )}
      {...props}
    >
